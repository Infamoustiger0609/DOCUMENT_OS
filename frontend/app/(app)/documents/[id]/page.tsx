...
// FieldValue/FieldRow/DetailCard moved to @/components/field-row so the
// landing page's "Extract" preview (see CLAUDE.md's Public landing page
// section) can reuse the exact same components with sample data.
